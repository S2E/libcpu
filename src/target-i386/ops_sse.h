...
#define SSE_HELPER_B(name, F)                                                                                          \
    void glue(name, SUFFIX)(Reg * d, Reg * s) {                                                                        \
        ...
        XMM_ONLY(W_D(d, B(8), F(R_D(d, B(8)), R_S(s, B(8)))); W_D(d, B(9), F(R_D(d, B(9)), R_S(s, B(9)))); W_D(d, B(10), F(R_D(d, B(10)), R_S(s, B(10))));       \
                 W_D(d, B(11), F(R_D(d, B(11)), R_S(s, B(11)))); W_D(d, B(12), F(R_D(d, B(12)), R_S(s, B(12)))); W_D(d, B(13), F(R_D(d, B(13)), R_S(s, B(13)))); \
...
#define SSE_HELPER_W(name, F)                                                                                 \
    void glue(name, SUFFIX)(Reg * d, Reg * s) {                                                               \
        ...
        XMM_ONLY(W_D(d, W(4), F(R_D(d, W(4)), R_S(s, W(4)))); W_D(d, W(5), F(R_D(d, W(5)), R_S(s, W(5)))); W_D(d, W(6), F(R_D(d, W(6)), R_S(s, W(6)))); \
                 W_D(d, W(7), F(R_D(d, W(7)), R_S(s, W(7))));)                                                              \
    }
...
void glue(helper_pmaddwd, SUFFIX)(Reg *d, Reg *s) {
    ...
    for (i = 0; i < (2 << SHIFT); i++) {
        W_D(d, L(i), (int16_t) R_S(s, W(2 * i)) * (int16_t) R_D(d, W(2 * i) + (int16_t) R_S(s, W(2 * i + 1)) * (int16_t) R_D(d, W(2 * i + 1))));
    }
}
...
void glue(helper_pmaddubsw, SUFFIX)(Reg *d, Reg *s) {
    W_D(d, W(0), satsw((int8_t) R_S(s, B(0)) * (uint8_t) R_D(d, B(0)) + (int8_t) R_S(s, B(1)) * (uint8_t) R_D(d, B(1))));
    W_D(d, W(1), satsw((int8_t) R_S(s, B(2)) * (uint8_t) R_D(d, B(2)) + (int8_t) R_S(s, B(3)) * (uint8_t) R_D(d, B(3))));
    W_D(d, W(2), satsw((int8_t) R_S(s, B(4)) * (uint8_t) R_D(d, B(4)) + (int8_t) R_S(s, B(5)) * (uint8_t) R_D(d, B(5))));
    W_D(d, W(3), satsw((int8_t) R_S(s, B(6)) * (uint8_t) R_D(d, B(6)) + (int8_t) R_S(s, B(7)) * (uint8_t) R_D(d, B(7))));
#if SHIFT == 1
    W_D(d, W(4), satsw((int8_t) R_S(s, B(8)) * (uint8_t) R_D(d, B(8)) + (int8_t) R_S(s, B(9)) * (uint8_t) R_D(d, B(9))));
    W_D(d, W(5), satsw((int8_t) R_S(s, B(10)) * (uint8_t) R_D(d, B(10)) + (int8_t) R_S(s, B(11)) * (uint8_t) R_D(d, B(11))));
    W_D(d, W(6), satsw((int8_t) R_S(s, B(12)) * (uint8_t) R_D(d, B(12)) + (int8_t) R_S(s, B(13)) * (uint8_t) R_D(d, B(13))));
    W_D(d, W(7), satsw((int8_t) R_S(s, B(14)) * (uint8_t) R_D(d, B(14)) + (int8_t) R_S(s, B(15)) * (uint8_t) R_D(d, B(15))));
#endif
}
...
#else
        r.Q(0) =
            SHR(R_S(s, Q(0)), shift - 0) | SHR(R_S(s, Q(1)), shift - 64) | SHR(R_D(d, Q(0)), shift - 128) | SHR(R_D(d, Q(1)), shift - 192);
        r.Q(1) =
            SHR(R_S(s, Q(0)), shift + 64) | SHR(R_S(s, Q(1)), shift - 0) | SHR(R_D(d, Q(0)), shift - 64) | SHR(R_D(d, Q(1)), shift - 128);
#endif
#undef SHR
    }
...
#define SSE_HELPER_F(name, elem, num, ty, F)        \
    void glue(name, SUFFIX)(Reg * d, Reg * s) { \
        W_D(d, elem(0), ty __RR_cpu_dyn(&F(0), sizeof(F(0))));                      \
        W_D(d, elem(1), ty __RR_cpu_dyn(&F(1), sizeof(F(1))));                      \
        if (num > 2) {                          \
            W_D(d, elem(2), ty __RR_cpu_dyn(&F(2), sizeof(F(2))));                  \
            W_D(d, elem(3), ty __RR_cpu_dyn(&F(3), sizeof(F(3))));                  \
            if (num > 4) {                      \
                W_D(d, elem(4), ty __RR_cpu_dyn(&F(4), sizeof(F(4))));              \
                W_D(d, elem(5), ty __RR_cpu_dyn(&F(5), sizeof(F(5))));              \
                W_D(d, elem(6), ty __RR_cpu_dyn(&F(6), sizeof(F(6))));              \
                W_D(d, elem(7), ty __RR_cpu_dyn(&F(7), sizeof(F(7))));              \
            }                                   \
        }                                       \
    } 
...
void glue(helper_dpps, SUFFIX)(Reg *d, Reg *s, uint32_t mask) {
    ...
    if (mask & (1 << 4))
        iresult = float32_add(iresult, float32_mul(R_D(d, XMM_S(0)), R_S(s, XMM_S(0)), &env->sse_status), &env->sse_status);
    if (mask & (1 << 5))
        iresult = float32_add(iresult, float32_mul(R_D(d, XMM_S(1)), R_S(s, XMM_S(1)), &env->sse_status), &env->sse_status);
    if (mask & (1 << 6))
        iresult = float32_add(iresult, float32_mul(R_D(d, XMM_S(2)), R_S(s, XMM_S(2)), &env->sse_status), &env->sse_status);
    if (mask & (1 << 7))
        iresult = float32_add(iresult, float32_mul(R_D(d, XMM_S(3)), R_S(s, XMM_S(3)), &env->sse_status), &env->sse_status);
...
void glue(helper_dppd, SUFFIX)(Reg *d, Reg *s, uint32_t mask) {
    ...
    if (mask & (1 << 4))
        iresult = float64_add(iresult, float64_mul(R_D(d, XMM_D(0)), R_S(s, XMM_D(0)), &env->sse_status), &env->sse_status);
    if (mask & (1 << 5))
        iresult = float64_add(iresult, float64_mul(R_D(d, XMM_D(1)), R_S(s, XMM_D(1)), &env->sse_status), &env->sse_status);
